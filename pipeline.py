...
def _extract():
    ...
    for news_site_uid in news_sites_uids:
        subprocess.run(['python','extract/main.py',news_site_uid],cwd='./extract')
...
def _transform():
    ...
    for news_site_uid in news_sites_uids:
        ...
        subprocess.run(['python','transform/main.py',dirty_data_filename],cwd='./transform')
        subprocess.run(['rm',dirty_data_filename],cwd='./transform')
        subprocess.run(['mv',clean_data_filename,'../load/{}'.format(clean_data_filename)],cwd='./transform')
...
def _load():
    ...
    for news_site_uid in news_sites_uids:
        ...
        subprocess.run(['python','load/main.py',clean_data_filename],cwd='./load')
